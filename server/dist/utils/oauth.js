...
class WechatOAuth {
  ...
  getAuthorizeURL() {
    return "".concat(util.format(codeWeixinUrl, this.appId, urlencode.encode('https://xiaozhenggms.cn/api/wxpay')), "&response_type=code&scope=snsapi_base&state=1#wechat_redirect");
  }
  getCodeUrl(code) {
